...
// Tu código acá:
const creator = document.querySelector("#createdBy");
creator.innerHTML += " Daniel Castillo";  
...
function buildToDos(toDos) {
  // Tu código acá:
  const newtoDoShells = toDos.map(buildToDo);
  return newtoDoShells;
}
...
function displayToDos() {
  ...
  for (const toDoShell of toDoShells){
    toDoContainer.appendChild(toDoShell);
  }
  /****************************************** con el forEach generamos un nuevo contexto de ejecucion por cada iteración*/
